...
console.log("rows1",rows)
  ...
  if (enableVirtualization) {
    ...
    const rowVisibleEndIdx = findRowIdx(scrollTop + clientHeight)+6        //need to be changed
    rowOverscanStartIdx = max(0, rowVisibleStartIdx - overscanThreshold)
    rowOverscanEndIdx = min(
      rows.length - 1,
      rowVisibleEndIdx + overscanThreshold
    )
    console.log("gridTemplateRows",findRowIdx(scrollTop),findRowIdx(scrollTop + clientHeight))
  }
  console.log("gridTemplateRows11",rowOverscanStartIdx,rowOverscanEndIdx)
